...
class DA_RNN(nn.Module):
    ...
    def test(self, on_train=False):
        ...
        plt.savefig('/home/lxw/1-th_code/MALSTM/DA-RNN-master/contrast_experiment/without_inputattn.png')
        plt.close(fig3)
...
if __name__ == '__main__':
    ...
    model = torch.load('/home/lxw/1-th_code/MALSTM/DA-RNN-master/contrast_experiment/without_inputattn.pth')
    model.test()