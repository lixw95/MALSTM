...
class DA_RNN(nn.Module):
    ...
    def test(self, on_train=False):
        ...
        plt.savefig('/home/lxw/1-th_code/MALSTM/DA-RNN-master/contrast_experiment/darnn.png')
        plt.close(fig3)

if __name__ == '__main__':
    print("==> Load dataset ...")
    model = DA_RNN(12, 128, 128, 52, 0.001, 500)
    #model.train()
    #torch.save(model, '/home/lxw/1-th_code/MALSTM/DA-RNN-master/contrast_experiment/darnn.pth')
    model = torch.load('/home/lxw/1-th_code/MALSTM/DA-RNN-master/contrast_experiment/darnn.pth')
    model.test()